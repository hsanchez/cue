...
public class Inflector {
  ...
  private class Rule {
    ...
    Rule(String expression, String replacement) {
  ...
  public static boolean isPlural(String a){
    return Objects.equals(a, getInstance().pluralize(a));
  }

  public Inflector copyOf() {
  ...
  public static String singularOf(String each){
    return Inflector.getInstance().singularize(each);
  }
